""" #genxcode - Sales Analysis Generated Report """
...
''', height=200)
    ...
    st.subheader("How to use this Streamlit Live Application")
    st.text("")
    
    st.caption("Si vous êtes français, appuyez sur l'icône des sous-titres.")
    
    st.divider()
    
    st.write("The video isn't available in this version.")
    ...
    if st.button("Help", icon="❗"):
        
        a = st.text_input("How can I help ?", max_chars= 1000)
    ...
    if upload_file is not None:
        ...
        if selected == "Français":
            ...
            def genere_pdf():
                ...
                myCanvas.setFont("Helvetica", 10)
                myCanvas.drawString(30, 70, pdf_auteur)
                myCanvas.drawString(30, 60, pdf_compagnie)
                myCanvas.drawString(30, 50, pdf_datefr)
            ...
            def genere_pdf():
                ...
                myCanvas.setFont("Helvetica", 10)
                myCanvas.drawString(30, 70, pdf_author)
                myCanvas.drawString(30, 60, pdf_company)
                myCanvas.drawString(30, 50, pdf_dateen)
